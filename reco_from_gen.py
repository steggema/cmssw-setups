...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        # '/store/relval/CMSSW_7_1_0_pre5/RelValTTbar_13/GEN-SIM/POSTLS171_V1-v1/00000/06810C44-F6B5-E311-8684-0025905A60A8.root')
        '/store/mc/Fall13/TTJets_MSDecaysCKM_central_Tune4C_13TeV-madgraph-tauola/GEN-SIM/POSTLS162_V1-v1/00000/F8433ED1-FCBD-E311-BB25-003048D2C16A.root')
)
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:reco_from_gen_ttbar_pu10.root'),
...
data = createDataset('CMS', '/RelValMinBias_13/CMSSW_7_1_0_pre5-POSTLS171_V1-v1/GEN-SIM', '*root', True)
...
# Schedule definition
process.schedule = cms.Schedule(process.simulation_step,process.digitisation_step,process.L1simulation_step,process.digi2raw_step,process.raw2digi_step,process.L1Reco_step,process.reconstruction_step,process.endjob_step,process.AODSIMoutput_step)
