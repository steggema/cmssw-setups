...
for mssm in [True, False]:
    ...
    for prefix in prefixes:
        if not mssm:
            ...
            systs = ['_CMS_scale_t_mutau_8TeV', '_QCDscale_ggH1in', '_CMS_htt_ZLScale_mutau_8TeV', '_CMS_htt_WShape_mutau_0jet_medium_8TeV', '_CMS_htt_WShape_mutau_0jet_high_8TeV', '_CMS_htt_WShape_mutau_1jet_medium_8TeV', '_CMS_htt_WShape_mutau_1jet_high_lowhiggs_8TeV', '_CMS_htt_WShape_mutau_1jet_high_mediumhiggs_8TeV', '_CMS_htt_WShape_mutau_vbf_loose_8TeV', '_CMS_htt_WShape_mutau_vbf_tight_8TeV']
        else:
            inFiles = [
            ...
            systs = ['_CMS_scale_t_mutau_8TeV', '_QCDscale_ggH1in', '_CMS_htt_ZLScale_mutau_8TeV']#, '_CMS_htt_WShape_mutau_btag_8TeV', '_CMS_htt_WShape_mutau_nobtag_8TeV'
