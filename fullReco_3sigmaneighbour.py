...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:reco_3sigmaneighbour.root'),
...
process.particleFlowRecHitECALWithTime.navigator.barrel.sigmaCut = cms.double(3.0)
process.particleFlowRecHitECALWithTime.navigator.endcap.sigmaCut = cms.double(3.0)
