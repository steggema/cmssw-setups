...
del process.particleFlowRecHitECALWithTime.navigator.barrel.timeResolutionCalc
del process.particleFlowRecHitECALWithTime.navigator.endcap.timeResolutionCalc
process.particleFlowRecHitECALWithTime.navigator.barrel.sigmaCut = cms.double(1.)
process.particleFlowRecHitECALWithTime.navigator.endcap.sigmaCut = cms.double(1.)
