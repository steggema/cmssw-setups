...
dirUp = '/data/steggema/Sep19MuTau_Up/'
dirDown = '/data/steggema/Sep19MuTau_Down/'
dirNom = '/data/steggema/Sep19MuTau/'

dirGGH = '/data/steggema/Sep19MuTau/'
...
for cat in catsSM:
    ...
    argsWJetsUp = ['python', 'plot_H2TauTauDataMC_TauMu_All.py', dirNom, 'tauMu_2012_cfg.py', '-C', cat, '-H', 'svfitMass', '-b', '-s', 'CMS_htt_WShape_mutau_{cat}_8TeVUp'.format(cat=catsSM[cat])]
    argsWJetsDown = ['python', 'plot_H2TauTauDataMC_TauMu_All.py', dirNom, 'tauMu_2012_cfg.py', '-C', cat, '-H', 'svfitMass', '-b', '-s', 'CMS_htt_WShape_mutau_{cat}_8TeVDown'.format(cat=catsSM[cat])]
...
mssmBinning, '-p', mssmBinning, '-g', '125']
            ...
            argsWJetsUp = ['python', 'plot_H2TauTauDataMC_TauMu_All.py', dirNom, 'tauMu_2012_cfg.py', '-C', cat, '-H', 'svfitMass', '-b', '-s', 'CMS_htt_WShape_mutau_{cat}_8TeVUp'.format(cat=catsMSSM[cat]), '-k', mssmBinning, '-p', mssmBinning, '-g', '125']
            argsWJetsDown = ['python', 'plot_H2TauTauDataMC_TauMu_All.py', dirNom, 'tauMu_2012_cfg.py', '-C', cat, '-H', 'svfitMass', '-b', '-s', 'CMS_htt_WShape_mutau_{cat}_8TeVDown'.format(cat=catsMSSM[cat]), '-k', mssmBinning, '-p', mssmBinning, '-g', '125']
