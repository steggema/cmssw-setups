...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:recoTestData.root'),
...
process.particleFlowClusterECALWithTimeSelected.timingCutsLowEndcap = cms.vdouble(-31.5, -20.5, -12.5, -12.5, -12.5, -12.5)
process.particleFlowClusterECALWithTimeSelected.timingCutsHighEndcap = cms.vdouble(31.5, 20.5, 12.5, 12.5, 12.5, 12.5)
