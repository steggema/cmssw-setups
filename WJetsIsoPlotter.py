...
def main():
    ...
    tfile = ROOT.TFile('/data/steggema/Sep19MuTau/WJetsSoup/H2TauTauTreeProducerTauMu/H2TauTauTreeProducerTauMu_tree.root')
    ...
    vars = [('svfitMass', 10, 0., 200.), ('mt', 10, 0., 150.)]

    # basicCuts = [(inc_sig, ''), (str(inc_sig)+'&&'+cat_J1, '1J'), (str(inc_sig)+'&&'+cat_J0, '0J')]
    basicCuts = [(inc_sig, ''), (str(inc_sig) + '&& nJets>=2 && VBF_nCentral==0 && VBF_mjj > 500 && abs(VBF_deta) > 3.5', 'VBF')]
