...
inputDir = '/data/steggema/Jul19MuTauIncl/'
inputCfg = 'tauMu_2012_cfg.py'
...
cats = [
	...
	('Xcat_IncX && mt<30 && Xcat_J1_high_mediumhiggsX', 'OneJetHighMediumHiggs'),
	('Xcat_IncX && mt<30 && Xcat_J1_high_lowhiggsX', 'OneJetHighLowHiggs'),
	('Xcat_IncX && mt<30 && Xcat_J1_mediumX', 'OneJetMedium'),
...
for cat in cats:
    args = ['python', 'plot_H2TauTauDataMC_TauMu_All.py', inputDir, inputCfg, '-H', 'nJets', '-C', cat[0], '-a', '-b', '-E', '-B', '-N', cat[1], '-g', '125']
    print args
