...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:gun_0_photon.root'),
...
process.AODSIMoutput.outputCommands.extend(['keep *_particleFlowRecHit*_*_*', 'keep *_pfTrack_*_*', 'keep *_pfDisplacedTrackerVertex_*_*', 'keep *_pfTrackElec_*_*', 'keep *_muons1stStep_*_*', 'keep *_pfConversions_*_*', 'keep *_pfSelectedElectrons_*_*', 'keep *_particleFlowTmp_*_*', 'keep *HepMCProduct*_generator_*_*', 'keep recoPFDisplacedVertexs_*_*_*',  'keep recoPFSimParticles_*_*_*', 'keep recoPFBlocks_particleFlowBlock_*_*', 'keep recoPFClusters_particleFlowCluster*_*_*', 'keep EcalUncalibRecHits*_*_*_*', 'keep *_*EcalRecHit*_*_*', 'keep *_*ecalRecHit*_*_*', 'keep *_ecalPreshowerRecHit_*_*', 'keep *_caloTowers_*_*', 'keep HBHERecHit*_*_*_*', 'keep CaloTowers*_*_*_*',
    'keep EBDigiCollection_ecalDigis_*_*', 'drop SimTracks_g4SimHits_*_*', 'drop SiStripClusteredmNewDetSetVector_siStripClusters__RECO', 'drop SimVertexs_g4SimHits__SIM', 'keep recoPFClusters_particleFlowClusterECAL_*_*','keep recoPFClusters_particleFlowClusterECALUncorrected_*_*','keep recoPFRecHits_*_*_*','keep recoPFClusters_*_*_*'])
...
process.mix.input = cms.SecSource("PoolSource",
        ...
        # fileNames = cms.untracked.vstring('file:gunShootOOTPhotons.root')
        fileNames = cms.untracked.vstring('file:gunShootOOTPhotons_plus.root')
)
...
process.mix.input.intFixed_OOT = cms.untracked.int32(0)
...
# process.ecalAmplitudeReco = cms.Sequence(process.ecalUncalibHitFixedAlphaBetaGammaFit)

process.ecalLocalRecoSequence.remove(process.ecalGlobalUncalibRecHit)
process.ecalLocalRecoSequence.insert(0, process.ecalUncalibHitFixedAlphaBetaGammaFit)
