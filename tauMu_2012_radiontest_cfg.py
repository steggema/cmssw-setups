...
pat = '/AbelianZprime_hh_TauTauBB_LHC8_M300_GENSIM_29082012/caber-Radion_hh_TauTauBB_LHC8_M300_31082013_AODSIM-c8f8ed334db8a7d6f56c62266b1dfa5b/USER/PAT_CMG_V5_16_0/TAUMU_SVFitVEGAS_Aug26_steggema'

radion = copy.deepcopy(HiggsVBF125)

radion.files = getFiles(pat, 'steggema', '.*root')

radion.splitFactor = 14

MC_list.extend([radion])
